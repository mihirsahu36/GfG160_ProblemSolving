...
class Solution {
    ...
    boolean isBST(Node node) {
        ...
        if(node != null){
            ...
            // inorder traversal of BST (Left->Root->Right) always appears in increasing order
            // prev stores the last visited node, and the current node should be greater than prev
