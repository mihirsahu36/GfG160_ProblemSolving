...
for 1: 0 0 1 => 1 set bit, for 2: 0 1 0 => 1 set bit, for 3: 0 1 1 => 2 set bits, for 4: 1 0 0 => 1 set bit.
...
class Solution {
    public static int countSetBits(int n) {
        ...
        int bitsBefore = x * (1 << (x - 1));
        int msbBits = n - (1 << x) + 1;
        int rest = n - (1 << x);
        
        return bitsBefore + msbBits + countSetBits(rest);
    }
