...
class Solution {
    ...
    public int[][] floodFill(int[][] image, int sr, int sc, int newColor) {
        ...
        solve(image, sr, sc, visit, image[sr][sc], newColor);
        
        return image;
    }
    
    private void solve(int[][] image, int row, int col, int [][]visit, int currColor, int newColor){
        ...
        solve(image, row - 1, col, visit, currColor, newColor);
        solve(image, row + 1, col, visit, currColor, newColor);
        solve(image, row, col - 1, visit, currColor, newColor);
        solve(image, row, col + 1, visit, currColor, newColor);
    }
}
