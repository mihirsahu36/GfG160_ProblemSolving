...
we can make one bouquet of the first three flowers that bloomed, but cannot make another bouquet.
After day 10: [x, x, x, x, x, x, x], Now we can make two bouquets, taking 3 adjacent flowers in one bouquet.
...
class Solution {
    private boolean check(int []arr, int k, int m, int days){
        int bouquets = 0;
        int count = 0;
