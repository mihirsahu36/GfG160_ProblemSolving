...
Both the next and random pointer of the new nodes should point to new nodes in the copied list, such that it also represent the same list state.
...
class Solution {
    public Node cloneLinkedList(Node head) {
        ...
        Node curr = head;
        while(curr != null){ // create new node after each node from original list
        ...
        curr = head;
        while(curr != null){ // assigning random pointer for new nodes
            if(curr.random != null){
        ...
        curr = head;
        while(curr != null){ // seperating the original and clone lists
